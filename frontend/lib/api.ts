...
export const api = {
  ...
  oeeRestoration: (id: string) => req<OeeRestorationView>(`/api/incidents/${id}/oee-restoration`),
  missionSpine: (id: string) => req<MissionSpineView>(`/api/incidents/${id}/mission-spine`),
